<?php
    ...
    if ($_COOKIE["forward"] == "yes") {
        $url = "https://heimkistenbestand.dampfkadse.de/a/".$_GET['id'].$_GET[''];
    ...
    $description = $item['items'][0]['publdesc'];
?>
<?php  
// set post fields
?>  
...
<p>In an emergency immediatly call <strong>017612176000</strong><p>
<form method="get" action="Dampfkadse_Vcard.vcf">
   <button type="submit">Download contact information!</button>
</form>
<p>If you think Dampfkadse lost it, please contact them via the following form:</p>
<p>Please make sure to put the Asset ID in the form</p>
